 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");const N=function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),n=1;n<t;n++)i[n-1]=arguments[n];return new z(e,i,"html",k)},I=133;function R(e,t){const i=e.element.content,n=e.parts,r=document.createTreeWalker(i,I,null,!1);let s=j(n),a=n[s],o=-1,l=0;const h=[];let c=null;for(;r.nextNode();){o++;const e=r.currentNode;for(e.previousSibling===c&&(c=null),t.has(e)&&(h.push(e),null===c&&(c=e)),null!==c&&l++;void 0!==a&&a.index===o;)a.index=null!==c?-1:a.index-l,a=n[s=j(n,s)]}h.forEach(e=>e.parentNode.removeChild(e))}const D=e=>{let t=11===e.nodeType?0:1;const i=document.createTreeWalker(e,I,null,!1);for(;i.nextNode();)t++;return t},j=function(e){for(let t=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:-1)+1;t<e.length;t++){const i=e[t];if(v(i))return t}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let wt=0;function Ct(){}Ct.prototype.__mixinApplications,Ct.prototype.__mixinSet;const xt=function(e){let t=e.__mixinApplications;t||(t=new WeakMap,e.__mixinApplications=t);let i=wt++;function n(n){let r=n.__mixinSet;if(r&&r[i])return n;let s=t,a=s.get(n);a||(a=e(n),s.set(n,a));let o=Object.create(a.__mixinSet||r||null);return o[i]=!0,a.__mixinSet=o,a}return n},St="link[rel=import][type~=css]",Mt="include",Ht="shady-unscoped";
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const Ca=e=>t=>(class extends t{connectedCallback(){this.__storeUnsubscribe=e.subscribe(()=>this._stateChanged(e.getState())),this._stateChanged(e.getState()),super.connectedCallback&&super.connectedCallback()}disconnectedCallback(){this.__storeUnsubscribe(),super.disconnectedCallback&&super.disconnectedCallback()}_stateChanged(e){throw new Error("_stateChanged() not implemented")}}),xa=(e,t)=>{t.dispatch(va.currentActionStart("SERVER_INFO",{url:e})),fetch(e,{method:"get",credentials:"same-origin",cache:"no-store"}).then(function(e){return e.json()}).then(function(e){t.dispatch(va.currentActionFinish("SERVER_INFO",e)),t.dispatch(la({remembered_user_count:e.remembered_user_count,unique_user_count:e.unique_user_count,total_connections:e.total_connections,total_channels:e.total_channels,total_messages:e.total_messages,total_unique_messages:e.total_unique_messages,uptime:e.uptime})),console.log("test",e.channels),console.log("test2",typeof Object.valueOf),console.log("test3",typeof Object.values);let i=Object.values(e.channels);t.dispatch(na(i))}).catch(function(e){t.dispatch(va.currentActionError("SERVER_INFO",e))})};class Sa extends(Ca(za)(oe)){render(){return N`
        <style>
            #admin-page-progress {
                width: 100%;
